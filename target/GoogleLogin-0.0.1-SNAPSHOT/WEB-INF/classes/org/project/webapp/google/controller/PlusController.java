...
public class PlusController {
  ...
  public PeoplePage getCircles(@PathVariable String id, @RequestParam(
  ...
  public PeoplePage getPlusOners(@PathVariable String activityId,
      @RequestParam(required = false) String pageToken) {
  ...
  public PeoplePage getResharers(@PathVariable String activityId,
      @RequestParam(required = false) String pageToken) {
  ...
  public ActivitiesPage searchPublicActivities(String query, @RequestParam(
      required = false) String pageToken) {
  ...
  public ActivitiesPage getActivities(@PathVariable String profileId,
      String pageToken) {
  ...
  public ActivityCommentsPage getComments(@PathVariable String activityId,
      @RequestParam(required = false) String pageToken) {
